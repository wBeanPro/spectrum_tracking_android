...
public class BetterGestureDetector {
     ...
     *
     * @param pressTimeout the new press timeout
     */
     ...
     *
     * @param tapTimeout the new tap timeout
     */
     ...
     *
     * @param moveEpsilon the new move epsilon
     */
     ...
     *
     * @param longPressTimeout the new long press timeout
     */
